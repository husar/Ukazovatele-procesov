                                       ...
                                       <form class="form-horizontal" role="form" method="POST" action="" enctype="multipart/form-data">
                                                   ...
                                                   <label class="col-md-3 control-label">Vyrobené kusy:</label>
                                                    <div class="col-md-6">
                                                      <div class="input-group">
                                                       <input class="form-control" type="number" step="0.01" placeholder="€" name="vyrobene_kusy" value="<?php echo $_POST['vyrobene_kusy']!=""?$_POST['vyrobene_kusy']:""; ?>">
                                                        <span class="input-group-addon">
                                                         <input type="checkbox" id="vyrobene_kusy" onclick="OptionsSelected(this)" <?php echo $_POST['noteVyrobeneKusy']!=""?"checked":""; ?>>
                                                          <label for="vyrobene_kusy">Pridať poznámku</label>
                                                        </span>
                                                      </div>
                                                    </div>
                                                </div>
                                                <div id="noteVyrobeneKusy" style="<?php echo $_POST['noteVyrobeneKusy']!=""?"":"display:none;" ?>">
                                                    <div  class="form-group" >
                                                        <label class="col-md-3 control-label">Poznámka</label>
                                                        <div class="col-md-7">
                                                        <textarea class="form-control" name="noteVyrobeneKusy" id="" cols="auto" rows="3"><?php echo $_POST['noteVyrobeneKusy']!=""?$_POST['noteVyrobeneKusy']:""; ?></textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                           ...
                                           <div class="form-group">
                                                   <label class="col-md-3 control-label">NTO v /%/ na vyrobené množstvo dielcov:</label>
                                                    <div class="col-md-6">
                                                      <div class="input-group">
                                                       <input class="form-control" type="number" step="0.01" placeholder="%" name="nto" value="<?php echo $_POST['nto']!=""?$_POST['nto']:""; ?>">
                                                        <span class="input-group-addon">
                                                         <input type="checkbox" id="nto" onclick="OptionsSelected(this)" <?php echo $_POST['noteNTO']!=""?"checked":""; ?>>
                                                          <label for="nto">Pridať poznámku</label>
                                                        </span>
                                                      </div>
                                                    </div>
                                                </div>
                                                <div id="noteNTO" style="<?php echo $_POST['noteNTO']!=""?"":"display:none;" ?>">
                                                    <div  class="form-group" >
                                                        <label class="col-md-3 control-label">Poznámka</label>
                                                        <div class="col-md-7">
                                                        <textarea class="form-control" name="noteNTO" id="" cols="auto" rows="3"><?php echo $_POST['noteNTO']!=""?$_POST['noteNTO']:""; ?></textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                   <label class="col-md-3 control-label">Hodnota NTO za celé obdobie:</label>
                                                    <div class="col-md-6">
                                                      <div class="input-group">
                                                       <input class="form-control" type="number" step="0.01" placeholder="€" name="nto_obdobie" value="<?php echo $_POST['nto_obdobie']!=""?$_POST['nto_obdobie']:""; ?>">
                                                        <span class="input-group-addon">
                                                         <input type="checkbox" id="nto_obdobie" onclick="OptionsSelected(this)" <?php echo $_POST['noteNTOObdobie']!=""?"checked":""; ?>>
                                                          <label for="nto_obdobie">Pridať poznámku</label>
                                                        </span>
                                                      </div>
                                                    </div>
                                                </div>
                                                <div id="noteNTOObdobie" style="<?php echo $_POST['noteNTOObdobie']!=""?"":"display:none;" ?>">
                                                    <div  class="form-group" >
                                                        <label class="col-md-3 control-label">Poznámka</label>
                                                        <div class="col-md-7">
                                                        <textarea class="form-control" name="noteNTOObdobie" id="" cols="auto" rows="3"><?php echo $_POST['noteNTOObdobie']!=""?$_POST['noteNTOObdobie']:""; ?></textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div id="priloha">
                                                ...
                                                <?php
                                                    ...
                                                    $documents = scandir("documents/waiting/PL200/");
                                                            ...
                                                            <p>
                                                                <?php 
                                                                        ...
                                                                        while($docIndex<count($documents)){ ?>
                                                                            <button type="submit" class="btn red" style="padding: 0px 4px; font-size: 10px" name="deleteDoc" value="<?php echo $documents[$docIndex]; ?>">x</button> <a href="documents/waiting/PL200/<?php echo $documents[$docIndex]; ?>" download><?php echo $documents[$docIndex]; ?></a><br>
                                                                  <?php           $docIndex++;
                                                                       }
